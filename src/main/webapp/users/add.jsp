                        ...
                        <form method="post">
                            <div class="form-group">
                                <label for="name">Nazwa <br>
                                    <input type="text" name="name" placeholder="Nazwa użytkownika" value="${userName}"
                            ...
                            <div class="form-group">
                                <label for="email">Email <br>
                                    <input type="email" name="email" placeholder="Email użytkownika" value="${email}"
                            ...
                            <div class="form-group">
                                <label for="password">Hasło <br>
                                    <input type="password" name="password" class="form-control"
                                           placeholder="Hasło użytkownika" value="${password}" id="password">
                                </label>
