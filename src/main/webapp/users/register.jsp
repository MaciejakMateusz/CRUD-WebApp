                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    ...
                                    <form class="user" action="${pageContext.request.contextPath}/user/register" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" placeholder="Wpisz nazwę użytkownika..." name="name" value="${userName}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Wpisz email..." name="email" value="${email}">
                                        </div>
                                        ...
                                        <c:if test="${emailExists==true}">
                                            ...
                                            Masz już konto? <a href="/user/login">Zaloguj się.</a></p>
                                        </c:if>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" placeholder="Wpisz hasło..." name="password" value="${password}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" placeholder="Powtórz hasło..." name="reEnteredPassword">
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="${pageContext.request.contextPath}/user/login">Masz już konto? Zaloguj!</a>
                                    </div>
                                </c:if>
                                <c:if test="${created==true}">
                                    <div class="text-center">
                                        ...
                                        <hr>
                                        <a href="${pageContext.request.contextPath}/user/login" class="btn btn-primary">Zaloguj się!</a>
                                    </div>
                                </c:if>
                            </div>
                        </div>
